class OwnershipsController < ApplicationController
  ...
  private
    ...
    def ownership_params
      params.require(:ownership).permit(:id,:user_id, :ip_asset_id,:stakeholding_percentage,
        ip_assets_attributes: [:id,:ip_asset_id,:_destroy],users_attributes: [:id,:user_id,:_destroy]
    end
end
